package Controller.DatabaseOperations.manageCartItems;
...
public class CartOperationsHandleler {
	...
	public static ResultSet getAllCartItems(HttpServletRequest request) {
		...
		String[] userData = UserOperationsHandleler.getCookiesData(request); 
